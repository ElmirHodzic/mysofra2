...
class MailList(APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            mail_from = 'mysofra.at@gmail.com'#request.data['mail_from'] if 'mail_from' in request.data else 
